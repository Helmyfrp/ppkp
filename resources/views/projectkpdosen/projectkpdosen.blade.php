    ...
    <div class="col-12" style="padding: 25px">
        ...
        <div class="modal" id="myModal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- Modal body -->
              <form action="/projectkpdosen/insert" method="POST" enctype='multipart/form-data'>
                @csrf
      ...
      <div class="container">
        <table class="table table-striped">
          ...
          <tbody>
            @foreach($dataProjectkpdosen as $item)
            <tr>
              <td>1</td>
              <td>{{$item->namalengkap}}</td>
              <td>{{$item->namafile}}</td>
              <td><a href="/projectkpdosen/{{ $item->id }}">
              ...
              <td>
                <a href="/projectkpdosen/{{ $item->id }}" button id="" type="button" class="btn btn-warning" data-toggle="modal1" data-target="#myModal1">
                  Ubah
                </a>
              </td>
              <td>
                <a href="/projectkpdosen/{{ $item->id ">
